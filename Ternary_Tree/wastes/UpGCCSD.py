...
# from .excitation import SingleLadExcitation, DoubleLadExcitation, SingleMajExcitation, DoubleMajExcitation
...
#                 if (self.tt[i][0].num <= 2*num_electrons) or (self.n_spatial * 2 + 1<= 
#                         self.tt[i][0].num <= 2*self.n_spatial + 2*num_electrons):
#                     cirq.x(i)
#                     # TODO
#                 else:
#                     cirq.id(i)
...
#         dp_lad_exc = copy.deepcopy(self.tup2lad(double_ladder_exc, name="t" + str(k) + "_"))
#         sp_maj_exc = self.almaj_double(
#             copy.deepcopy(self.lad2maj(single_ladder_alpha_exc, name="t" + str(k) + "_")),
#             n
#         )
#         double_exc_layer()
